...
export const casinoGames: CasinoGame[] = [
  ...
  { id: "blackjack", name: "Blackjack", href: "/casino/blackjack", category: "Table", provider: "SportyStake", rtp: 99.50, minBet: 1, maxBet: 5000, color: "#06291a", accent: "#10b981", tag: "NEW", description: "Beat the dealer's 17 without busting." },
  { id: "baccarat", name: "Baccarat", href: "/casino/baccarat", category: "Table", provider: "SportyStake", rtp: 98.80, minBet: 1, maxBet: 5000, color: "#082823", accent: "#14b8a6", tag: "NEW", description: "Player, Banker, or Tie — closest to 9 wins." },
];
...
export const promos = [
  {
    ...
    subtitle: "Double your bankroll on your first settled wager · Instant USDC credit · Zero KYC required",
    cta: "Claim $2,000 Bonus",
    href: "/sportsbook",
    gradient: "",
    accent: "#00e701",
    tnc: "100% bonus match up to $2,000 USDC on your first settled wager. Terms apply.",
  },
  {
    id: "p-parlay",
    tag: "Multi-Market Parlays",
    title: "Combine Predictions with Live Sports",
    subtitle: "Add Bitcoin, macro and world events alongside Premier League and Champions League matches for compounded parlay odds",
    cta: "Build Parlay",
    href: "/prediction-markets",
    gradient: "",
    accent: "#2dc4ff",
    tnc: "Combine prediction market outcomes with sports selections in your betslip for multiplied payouts.",
  },
  {
    id: "p-casino",
  ...
  },
  {
    ...
    title: "Earn Perpetual Revenue on Every Wager",
    subtitle: "Invite friends and receive up to 25% house margin share on all settled bets for life",
    cta: "Get Referral Link",
    href: "/profile",
    gradient: "",
    accent: "#2dc4ff",
    tnc: "Referrers receive up to 25% commission on settled wagers. No earnings cap. Terms apply.",
  },
  {
    id: "p3",
    tag: "Social Betting",
    title: "Earn on Shared Bet Tickets",
    subtitle: "Share your bet slips on X & Telegram · Earn instant commissions whenever other players tail your ticket",
    cta: "Share & Earn",
    href: "/social",
    gradient: "",
    accent: "#ffb800",
    tnc: "Earn commission on total volume copied via your unique ticket code.",
  },
];
